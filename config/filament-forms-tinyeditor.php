    ...
    */
    ...
    'profiles' => [
        ...
        'default' => [
            ...
            'custom_configs' => [
                'content_style' => "@import url('https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&display=swap'); body { font-family: 'Inter'; }",
            ]
        ],
