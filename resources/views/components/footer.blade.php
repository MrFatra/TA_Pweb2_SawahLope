<footer class="text-center">
    ...
    <div class="links flex flex-wrap justify-center gap-4 mb-4">
        ...
        <a href="reservasi" class="text-gray-700 hover:text-green-500">Reservasi</a>
        <a href="artikel" class="text-gray-700 hover:text-green-500">Artikel</a>
        <a href="peta" class="text-gray-700 hover:text-green-500">Peta Panduan</a>
    </div>
