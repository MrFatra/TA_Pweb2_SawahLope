            ...
            <form method="POST" action="{{ route('pay.buyTicket') }}">
                ...
                <div class="mb-5">
                    ...
                    <input id="full_name" name="full_name" type="text" required
                        class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm px-5 py-3">
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input id="visit_date" name="visit_date" required
                            ...
                            type="text" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm ps-10 p-3"
                            placeholder="Pilih Tanggal Kunjungan">
                    </div>
                </div>

                <div class="mb-5">
                    <label for="guest_count" class="block text-sm font-medium text-gray-700">Jumlah Pengunjung</label>
                    <input id="guest_count" name="guest_count" type="number" min="1" value="1" required
                        class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm px-5 py-3">
                </div>

                <div class="mb-8">
                    <label for="total_price" class="block text-sm font-medium text-gray-700">Total Harga (IDR)</label>
                    <input id="total_price" name="total_price" type="text" readonly
                        class="mt-1 block w-full border border-gray-300 bg-gray-100 rounded-lg shadow-sm px-5 py-3 text-gray-600">
                    <p class="text-sm font-medium text-gray-500">Harga tiket dihitung berdasarkan jumlah pengunjung.</p>
                </div>

                <button type="submit"
                    class="w-full bg-green-500 text-white py-3 rounded-md hover:bg-green-700 transition cursor-pointer">
                    Beli Tiket Sekarang!
                </button>
            </form>
        </div>
